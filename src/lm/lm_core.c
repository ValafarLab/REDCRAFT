...
/*  if(n<m){
    fprintf(stderr, LCAT(LEVMAR_DER, "(): cannot solve problem with fewer measurements [%d] than unknowns [%d]\n"), n, m);
    return LM_ERROR;
  }
*/
...
/*  if(n<m){
    fprintf(stderr, LCAT(LEVMAR_DIF, "(): cannot solve problem with fewer measurements [%d] than unknowns [%d]\n"), n, m);
    return LM_ERROR;
  }
*/
